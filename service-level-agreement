...
A _Service Level Agreement_, also sometimes called an SLA, usually sets out two main things:
...
It may also deal with matters like:
- who is responsible for monitoring a service's performance and reporting on it; and
- a description of the basic elements underlying service performance, such as network connectivity, domain name servers, and dynamic host configuration protocol servers.
...
E.g:
- 5% discount for less than 99% availaility;
- 10% discount for less than 95% availability;
- 20% discount for less than 90% availability.
